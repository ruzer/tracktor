...
<div class="mt-8">
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <span class="text-xl font-bold text-gray-800 dark:text-gray-100">{insurance.provider}</span>
        </div>
        <div class="flex gap-2">
            <button on:click={handleEditInsurance} class="text-gray-500 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                <Pencil class="h-5 w-5" />
            </button>
            <button on:click={handleDeleteInsurance} class="text-gray-500 hover:text-red-600 dark:text-gray-300 dark:hover:text-red-400">
  ...
  {:else}
    <div class="text-center">
      ...
      <button on:click={handleAddInsurance} class="mt-4 rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
        Add Insurance
      </button>
    </div>
  {/if}
