...
--> statement-breakpoint
INSERT INTO `__new_auth`("id", "hash", "created_at", "updated_at") SELECT "id", "hash", "created_at", "updated_at" FROM `auth`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_configs`("key", "value", "description", "created_at", "updated_at") SELECT "key", "value", "description", "created_at", "updated_at" FROM `configs`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_vehicles`("id", "make", "model", "year", "license_plate", "vin", "vin_number", "engine_number", "color", "odometer", "tank_size_liters", "status", "ownership_type_id", "owner_name", "created_at", "updated_at") SELECT "id", "make", "model", "year", "license_plate", "vin", "vin_number", "engine_number", "color", "odometer", "tank_size_liters", "status", "ownership_type_id", "owner_name", "created_at", "updated_at" FROM `vehicles`;--> statement-breakpoint
DROP TABLE `vehicles`;--> statement-breakpoint
ALTER TABLE `__new_vehicles` RENAME TO `vehicles`;