...
<div class="color-picker">
	...
	<div class="mb-4 flex items-center gap-3">
		<div
			class="h-12 w-12 rounded-lg border-2 border-gray-300 shadow-sm dark:border-gray-600"
	...
	<div class="mb-4">
		...
		<div class="grid grid-cols-6 gap-2">
			{#each commonColors as color}
				<button
					type="button"
					class="h-10 w-10 rounded-lg border-2 transition-all hover:scale-110 focus:ring-2 focus:ring-blue-500 focus:outline-none"
